...
import "../HtmlBasics/HtmlBasics.scss";
...
export default function HtmlBasics() {
  ...
  useEffect(() => {
    CATEGORIES_API.getAll("html-basics").then((res) => setFlipCard(res.data));
    // console.log(res);
  }, []);
  ...
  return (
    <section className="html-basics">
      <div className="html-basics__top">
        <div className="html-basics__back-divider">
          <NavLink to="/html">
      ...
      <div className="html-basics__card-divider">
        {flashcards.map((card) => {
          return (
            <>
              <div
                className={`html-basics__card-container ${
                  card.flipped ? "html-basics__flip-card" : ""
                } `}
              >
                <div
                  ...
                  className={`html-basics__card ${
                    card.correct
                      ? card.correct === "correct"
                        ? "html-basics__correct-background"
                        : "html-basics__incorrect-background"
                      : ""
                  }  ${
                    card.correct
                      ? card.correct === "clear"
              ...
              {card.flipped ? (
                <div className="html-basics__select-container">
                  ...
                  <p
                    className="html-basics__favorite"
