  ...
  return (
    <section className="terminal">
      <div className="terminal__top">
        ...
        <div className="terminal__count-container">
          <p className="terminal__count-display">
            <span className="terminal__correct-modifier">Correct:</span>{" "}
            <span className="terminal__number-modifier">{count >= 0 ? count : false}</span>/30
          </p>
        </div>
        <div className="terminal__button-divider">
          ...
          <button
            onClick={() => setTimer(0)}
            className="terminal__reset-button"
          >
            Reset
          </button>
        </div>
        ...
        {flashcards.map((card) => {
          return (
            <>
                  ...
                  className={`terminal__card ${
                    card.correct
                      ? card.correct === "correct"
                        ? "terminal__correct-background"
                        : "terminal__incorrect-background"
                      : ""
                  }  ${
                    card.correct
                      ? card.correct === "clear"
                        ? "terminal__clear-background"
                        : ""
                      : ""
                  } 
                  ${
              ...
              {card.flipped ? (
                <div className="terminal__select-container">
                  <p
                    className="terminal__correct"
